...
pythonSources: list[str] = ["addon/globalPlugins/*", "addon/*.py"]
...
excludedFiles: list[str] =[i[6:] for i in glob("addon/doc/*/*.md")+glob("addon/locale/*/LC_MESSAGES/*.po")]+[os.path.join("doc", "en", "readme.md")]
